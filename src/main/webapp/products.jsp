    ...
    <div class="small-container">
        ...
        <div class="row">
            <div class="col-4">
                ...
                <p>INR 500.0</p>
                <button><a href="addtocart.jsp?id=<%=1 %>">Add to cart</a></div></button>
            </div>
            ...
            <div class="col-4">
                ...
                <p>INR 650.0</p>
                <button><a href="addtocart.jsp?id=<%=2 %>">Add to cart</a></div></button>
            </div>
            ...
            <div class="col-4">
                ...
                <p>INR 450</p>
                <button><a href="addtocart.jsp?id=<%=3 %>">Add to cart</a></div></button>
            </div>
            ...
            <div class="col-4">
                ...
                <p>INR 450</p>
                <button>><a href="addtocart.jsp?id=<%=4 %>">Add to cart</a></div></button>
            </div>
            ...
            <div class="col-4">
                ...
                <p>INR 690.0</p>
              <button> <a href="addtocart.jsp?id=<%=5 %>">Add to cart</a></div></button>
            </div>
